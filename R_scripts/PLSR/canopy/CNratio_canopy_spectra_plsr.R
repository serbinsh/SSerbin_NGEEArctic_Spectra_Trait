...
#output_dir <- "tempdir"
output_dir <- file.path("~/Data/Dropbox/MANUSCRIPTS/BNL_TEST/SSerbin_NGEEArctic_Spectra_Trait/R_Output/PLSR/canopy/CN_ratio-v6")
#--------------------------------------------------------------------------------------------------#
...
sample_info2 <- sample_info %>%
  select(Location, Sample_ID, Sample_Date, USDA_Species_Code, Spec_Instrument=Instrument, Cmass_mg_g, 
         Nmass_mg_g, LMA_gDW_m2, Carea_g_m2, Narea_g_m2, CN_ratio)
...
### outlier cleanup
remove_sampleIDs <- c("BNL12997","BNL1745","BNL12966","BNL12999","BNL1749",
                      "BNL2813","BNL1746","BNL2812","BNL13037","BNL1684")
plsr_data <- plsr_data %>%
...
#use_this_seed <- 3863546 # v5
use_this_seed <- 113 # v6
