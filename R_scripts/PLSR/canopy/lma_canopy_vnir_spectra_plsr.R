...
#output_dir <- "tempdir"
output_dir <- file.path("~/Data/Dropbox/MANUSCRIPTS/BNL_TEST/SSerbin_NGEEArctic_Spectra_Trait/R_Output/PLSR/vnir_canopy/LMA")
#--------------------------------------------------------------------------------------------------#
...
sample_info2 <- sample_info %>%
  mutate(sqrt_LMA_gDW_m2=sqrt(LMA_gDW_m2)) %>%
  select(Location, Sample_ID, Sample_Date, USDA_Species_Code, Spec_Instrument=Instrument, Cmass_mg_g, 
         Nmass_mg_g, LMA_gDW_m2, sqrt_LMA_gDW_m2, Carea_g_m2, Narea_g_m2, CN_ratio)
...
remove_sampleIDs <- c("BNL13037","BNL13147","BNL12994","BNL13151","BNL13077",
                      "BNL13072","BNL13331","BNL13190","BNL13189","BNL1830",
                      "BNL13193","BNL1588")
