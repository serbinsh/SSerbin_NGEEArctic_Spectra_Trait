...
#
#
#    --- Last updated: 04.07.2021 By Shawn P. Serbin <sserbin@bnl.gov>
####################################################################################################
...
head(cr)[,1:6]
merged_data <- merge(x = chn_lma_data, y = cr, by = "Sample_ID")
...
sample_info2 <- sample_info %>%
  mutate(sqrt_Narea_g_m2=sqrt(Narea_g_m2)) %>%
  select(Location, Sample_ID, Sample_Date, USDA_Species_Code, Spec_Instrument=Instrument, Cmass_mg_g, 
         Nmass_mg_g, LMA_gDW_m2, Carea_g_m2, Narea_g_m2, sqrt_Narea_g_m2, CN_ratio)
...
### outlier cleanup
remove_sampleIDs <- c("BNL2813","BNL2808","BNL2808","BNL2811","BNL2813","BNL1867","BNL13044","BNL1731","BNL1940",
                      "BNL1875","BNL1684","BNL1745","BNL13153","BNL13146","BNL13088","BNL2350",
                      "BNL2812","BNL1941","BNL1746","BNL13154","BNL1830","BNL13495","BNL13323",
                      "BNL2807","BNL12993","BNL1703")
plsr_data <- plsr_data %>%
