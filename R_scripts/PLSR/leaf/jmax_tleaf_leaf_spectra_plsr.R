...
head(nga_gasex_data$Utqiagvik_2016_1pt_Vcmax)
...
SewPen_data_temp_data <- temperature_data$SewPen_data %>%
  select(Sample_ID,Spec_Tair_degC=TairLeaf_degC,Preferred_Spec_Tleaf_degC=Tleaf_degC)
...
remove_sampleIDs <- c("BNL14204","BNL1646","BNL15354","BNL1630","BNL12958","BNL14207","BNL14209",
                      "BNL14202","BNL1578","BNL1560","BNL1562",
                      "BNL1589","BNL1588","BNL1572",
...
split_data <- spectratrait::create_data_split(dataset=plsr_data, approach=method, split_seed=use_this_seed, 
                                              prop=0.8, group_variables=c("Location","USDA_Species_Code"))
names(split_data)
