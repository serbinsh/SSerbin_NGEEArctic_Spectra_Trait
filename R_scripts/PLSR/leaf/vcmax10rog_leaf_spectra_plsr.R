...
#output_dir <- "tempdir"
output_dir <- file.path("~/Data/Dropbox/MANUSCRIPTS/BNL_TEST/SSerbin_NGEEArctic_Spectra_Trait/R_Output/PLSR/leaf/Vcmax10_Rogers.v1")
#--------------------------------------------------------------------------------------------------#
...
Utqiagvik_2016_1pt_Vcmax2 <- Utqiagvik_2016_1pt_Vcmax %>%
  ...
  mutate(Vcmax10_Rog=arrhenius(Tleaf,10,VcmaxT_one_point,54.26)) %>%
  select(Location,Method,Sample_ID,Sample_Date,USDA_Species_Code,
         Tleaf,Vcmax_Tleaf=VcmaxT_one_point,Vcmax25_Rog,Vcmax10_Rog)
Utqiagvik_2012_2015_VcmaxJmax_data2 <- Utqiagvik_2012_2015_VcmaxJmax_data %>%
  ...
  mutate(Vcmax10_Rog=arrhenius(Tleaf,10,Vcmax_Tleaf,54.26)) %>%
  select(Location,Method,Sample_ID,Sample_Date,USDA_Species_Code,
         Tleaf,Vcmax_Tleaf,Vcmax25_Rog,Vcmax10_Rog)
...
sample_info2 <- sample_info %>%
  select(Location, GasEx_Method=Method, Sample_ID, Sample_Date, USDA_Species_Code, 
         Spec_Instrument=Instrument, Tleaf, Vcmax_Tleaf, Vcmax25_Rog, Vcmax10_Rog)
head(sample_info2)
