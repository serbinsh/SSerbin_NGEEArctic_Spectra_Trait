...
#output_dir <- "tempdir"
output_dir <- file.path("~/Data/Dropbox/MANUSCRIPTS/BNL_TEST/SSerbin_NGEEArctic_Spectra_Trait/R_Output/PLSR/leaf/Vcmax25_Bernacchi.v2")
#--------------------------------------------------------------------------------------------------#
...
Utqiagvik_2016_1pt_Vcmax2 <- Utqiagvik_2016_1pt_Vcmax %>%
  ...
  select(Location,Method,Sample_ID,Sample_Date,USDA_Species_Code,
         Tleaf,Vcmax_Tleaf=VcmaxT_one_point,Vcmax25_Bern)
Utqiagvik_2012_2015_VcmaxJmax_data2 <- Utqiagvik_2012_2015_VcmaxJmax_data %>%
  ...
  select(Location,Method,Sample_ID,Sample_Date,USDA_Species_Code,
         Tleaf,Vcmax_Tleaf,Vcmax25_Bern)
...
sample_info2 <- sample_info %>%
  select(Location, GasEx_Method=Method, Sample_ID, Sample_Date, USDA_Species_Code, 
         Spec_Instrument=Instrument, Tleaf, Vcmax_Tleaf, Vcmax25_Bern)
head(sample_info2)
